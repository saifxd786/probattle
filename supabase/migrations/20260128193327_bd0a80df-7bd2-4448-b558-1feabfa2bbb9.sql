-- Update create_ludo_room to support free matches (entry_amount = 0)
...
BEGIN
  ...
  -- Only deduct entry amount if not a free match
  IF p_entry_amount > 0 THEN
...
-- Update join_ludo_room to support free matches
