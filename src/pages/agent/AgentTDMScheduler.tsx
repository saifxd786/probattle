...
import { Clock, Play, RefreshCw, Calendar, AlertTriangle, CheckCircle2, XCircle, Settings2, ShieldX } from 'lucide-react';
...
const AgentTDMScheduler = () => {
  ...
  useEffect(() => {
    if (permissions.can_schedule_tdm_matches) {
      fetchSettings();
      fetchTodaysMatches();
  ...
  }, [permissions.can_schedule_tdm_matches]);
    ...
    return (
      <div className="p-6 flex flex-col items-center justify-center min-h-[50vh] gap-4">
        ...
        <p className="text-muted-foreground text-center">
          You don't have permission to schedule TDM matches.<br />
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm">
              ...
              <ul className="text-muted-foreground mt-1 space-y-1 list-disc list-inside">
                ...
                <li>Matches auto-cancel {settings?.auto_cancel_seconds || 10}s before start if not full</li>
...
export default AgentTDMScheduler;
