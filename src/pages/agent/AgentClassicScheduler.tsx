...
import { Clock, Play, RefreshCw, Calendar, AlertTriangle, CheckCircle2, XCircle, Settings2, MapPin, ShieldX } from 'lucide-react';
...
const AgentClassicScheduler = () => {
  ...
  useEffect(() => {
    if (permissions.can_schedule_classic_matches) {
      fetchSettings();
      fetchTodaysMatches();
  ...
  }, [permissions.can_schedule_classic_matches]);
    ...
    return (
      <div className="p-6 flex flex-col items-center justify-center min-h-[50vh] gap-4">
        ...
        <p className="text-muted-foreground text-center">
          You don't have permission to schedule Classic matches.<br />
...
export default AgentClassicScheduler;
