...
const UpdatePopup = ({ isOpen, onUpdate, isUpdating }: UpdatePopupProps) => {
  ...
  return (
    <AlertDialog open={isOpen}>
      <AlertDialogContent className="max-w-sm bg-gradient-to-br from-background via-background to-primary/5 border-primary/20 [&>button]:hidden !flex !flex-col max-h-[85vh] overflow-hidden">
